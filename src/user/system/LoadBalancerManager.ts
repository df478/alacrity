...
const ALACRITY_CONTAINER_PATH_OF_FAKE_CERTS =
...
if (!fs.existsSync(ALACRITY_CONTAINER_PATH_OF_FAKE_CERTS))
    throw new Error('ALACRITY_CONTAINER_PATH_OF_FAKE_CERTS  is empty')
if (!defaultPageTemplate) throw new Error('defaultPageTemplate  is empty')

const DH_PARAMS_FILE_PATH_ON_HOST = path.join(
    AlacranConstants.nginxSharedPathOnHost,
    AlacranConstants.nginxDhParamFileName
)

const DH_PARAMS_FILE_PATH_ON_NGINX = path.join(
    AlacranConstants.nginxSharedPathOnNginx,
    AlacranConstants.nginxDhParamFileName
)
...
class LoadBalancerManager {
    ...
    private alacranPublicRandomKey: string
    ...
    constructor(
        ...
        this.alacranPublicRandomKey = uuid()
    }
    ...
    consumeQueueIfAnyInNginxReloadQueue() {
        ...
        // This will resolve to something like: /alacran/nginx/conf.d/alacran
        const configFilePathBase = `${
            AlacranConstants.perAppNginxConfigPathBase
            ...
            .then(function (servers) {
                ...
                if (servers && !!servers.length) {
                    for (let i = 0; i < servers.length; i++) {
                        ...
                        s.staticWebRoot = `${
                            AlacranConstants.nginxStaticRootDir +
                            AlacranConstants.nginxDomainSpecificHtmlDir
                        }/${s.publicDomain}`

                        s.customErrorPagesDirectory =
                            AlacranConstants.nginxStaticRootDir +
                            AlacranConstants.nginxDefaultHtmlDir
        ...
        return Promise.resolve()
            .then(function () {
                return self.dockerApi.executeCommand(
                    AlacranConstants.nginxServiceName,
                    ['nginx', '-t']
                )
            })
    ...
    getAlacranPublicRandomKey() {
        return this.alacranPublicRandomKey
    }

    getSslCertPath(domainName: string) {
        const self = this
        return (
            AlacranConstants.letsEncryptEtcPathOnNginx +
    ...
    getLogPath(appName: string, domainName: string) {
        return `${AlacranConstants.nginxSharedLogsPath}/${this.getLogName(appName, domainName)}`
    }
    ...
    getInfo() {
        return new Promise<LoadBalancerInfo>(function (resolve, reject) {
            const url = `http://${AlacranConstants.nginxServiceName}/nginx_status`
    ...
    createRootConfFile() {
        ...
        const FUTURE = AlacranConstants.rootNginxConfigPath + '.fut'
        const BACKUP = AlacranConstants.rootNginxConfigPath + '.bak'
        const CONFIG = AlacranConstants.rootNginxConfigPath + '.conf'
        ...
        return Promise.resolve()
            ...
            .then(function (nginxConfig) {
                rootNginxTemplate =
                    nginxConfig.alacranConfig.customValue ||
                    nginxConfig.alacranConfig.byDefault
            ...
            .then(function (hasRegistrySsl) {
                return ejs.render(rootNginxTemplate!, {
                    ...
                    alacran: {
                        crtPath: self.getSslCertPath(alacranDomain),
                        keyPath: self.getSslKeyPath(alacranDomain),
                        hasRootSsl: hasRootSsl,
                        serviceName: AlacranConstants.alacranServiceName,
                        domain: alacranDomain,
                        serviceContainerPort3000:
                            AlacranConstants.serviceContainerPort3000,
                        defaultHtmlDir:
                            AlacranConstants.nginxStaticRootDir +
                            AlacranConstants.nginxDefaultHtmlDir,
                        staticWebRoot: `${
    ...
    ensureBaseNginxConf() {
        ...
        return Promise.resolve()
            ...
            .then(function (alacranConfig) {
                const baseConfigTemplate =
                    alacranConfig.baseConfig.customValue ||
                    alacranConfig.baseConfig.byDefault
            ...
            .then(function (baseNginxConfFileContent) {
                return fs.outputFile(
                    AlacranConstants.baseNginxConfigPath,
    ...
    init(myNodeId: string, dataStore: DataStore) {
        ...
        function createNginxServiceOnNode(nodeId: string) {
            Logger.d(
                'No Alacran Nginx service is running. Creating one on alacran node...'
            )

            return dockerApi
                .createServiceOnNodeId(
                    AlacranConstants.configs.nginxImageName,
                    AlacranConstants.nginxServiceName,
                    [
                        {
                            protocol: 'tcp',
        ...
        return fs
            .outputFile(
                ...
                self.getAlacranPublicRandomKey()
            )
            .then(function () {
            ...
            .then(function () {
                return ejs.render(defaultPageTemplate, {
                    ...
                    message_body:
                        "If you are the developer, check your application's logs.",
                    message_link: '',
            ...
            .then(function (error502PageContent) {
                return fs.outputFile(
                    AlacranConstants.alacranStaticFilesDir +
                        AlacranConstants.nginxDefaultHtmlDir +
                        '/alacran_502_custom_error_page.html',
                    error502PageContent
                )
            })
            .then(function () {
                ...
                return fs.copy(
                    ALACRITY_CONTAINER_PATH_OF_FAKE_CERTS,
            ...
            .then(function () {
                return fs.ensureDir(AlacranConstants.nginxSharedPathOnHost)
            })
            .then(function () {
            ...
            .then(function (isRunning) {
                if (isRunning) {
                    Logger.d('Alacran Nginx is already running.. ')
                    ...
                    Logger.d('Alacran Nginx is NOT running.. ')
            ...
            .then(function (nodeId) {
                if (nodeId !== myNodeId) {
                    Logger.d(
                        'Alacran Nginx is running on a different node. Removing...'
                    )

                    return dockerApi
                        .removeServiceByName(AlacranConstants.nginxServiceName)
                        .then(function () {
            ...
            .then(function () {
                ...
                return dockerApi.updateService(
                    ...
                    [
                        {
                            containerPath: AlacranConstants.nginxStaticRootDir,
                            hostPath: AlacranConstants.alacranStaticFilesDir,
                        },
                        {
                        ...
                        },
                        {
                            ...
                            hostPath: AlacranConstants.baseNginxConfigPath,
                        },
                        {
                        ...
                        },
                        {
                            containerPath:
                                AlacranConstants.nginxSharedPathOnNginx,
                            hostPath: AlacranConstants.nginxSharedPathOnHost,
                        },
                        {
                            hostPath:
                                AlacranConstants.nginxSharedLogsPathOnHost,
                            containerPath: AlacranConstants.nginxSharedLogsPath,
                        },
                    ],
