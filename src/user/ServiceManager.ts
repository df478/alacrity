...
class ServiceManager {
            ...
            .then(function () {
                ...
                self.eventLogger.trackEvent(
                    AlaCrityEventFactory.create(
                        AlaCrityEventType.AppBuildSuccessful,
                        {
                            appName,
                        }
                    )
    ...
    enableCustomDomainSsl(appName: string, customDomain: string) {
        ...
        return Promise.resolve()
            ...
            .then(function (rootHasSsl) {
                ...
                Logger.d(`Verifying Alacran owns domain: ${customDomain}`)

                return self.domainResolveChecker.verifyAlacranOwnsDomainOrThrow(
                    customDomain,
                    undefined
                )
            })
    ...
    enableSslForApp(appName: string) {
        ...
        return Promise.resolve()
            ...
            .then(function (rootHasSsl) {
                ...
                return self.verifyAlacranOwnsGenericSubDomain(appName)
            })
            .then(function () {
    ...
    verifyAlacranOwnsGenericSubDomain(appName: string) {
        const self = this
        ...
        return Promise.resolve()
            ...
            .then(function (domainName) {
                Logger.d(`Verifying Alacran owns domain: ${domainName}`)
    ...
    createPreDeployFunctionIfExist(
        ...
        ////////////////////////////////// Expected content of the file //////////////////////////
            ...
            preDeployFunction = function (alacranAppObj, dockerUpdateObject) {
                return Promise.resolve()
                        .then(function(){
                    ...
                    if (existingAppDefinition) {
                        ...
                        return dataStore
                            ...
                            .updateAppDefinitionInDb(
                                ...
                                existingAppDefinition.alacranDefinitionRelativeFilePath,
    ...
    logBuildFailed(appName: string, error: string) {
        ...
        self.eventLogger.trackEvent(
            AlaCrityEventFactory.create(AlaCrityEventType.AppBuildFailed, {
                appName,
        ...
        return Promise.resolve() //
            .then(function () {
                return dockerApi.getLogForService(
                    serviceName,
                    AlacranConstants.configs.appLogSize,
                    encoding
                )
            })
    }
                ...
                if (isRunning) {
                    ...
                    return dockerApi
                        .createServiceOnNodeId(
                            AlacranConstants.configs.appPlaceholderImageName,
                            serviceName,
                            undefined,
                            undefined,
                            undefined,
