...
function isNameAllowed(name: string) {
    const isNameFormattingOk =
        ...
        /^[a-z0-9\-]+$/.test(name) &&
        name.indexOf('--') < 0
    return isNameFormattingOk && ['alacran', 'registry'].indexOf(name) < 0
}
...
class AppsDataStore {
    ...
    setEncryptor(encryptor: AlacranEncryptor) {
    ...
    getAppDefinitions() {
        ...
        return new Promise<IAllAppDefinitions>(function (resolve, reject) {
            ...
            Object.keys(allApps).forEach(function (appName) {
                ...
                appUnencrypted.alacranDefinitionRelativeFilePath =
                    appUnencrypted.alacranDefinitionRelativeFilePath ||
                    AlacranConstants.defaultAlacranDefinitionPath
    ...
    createNewVersion(appName: string) {
        ...
        return this.getAppDefinition(appName).then(function (app) {
            ...
            app.versions = Utils.dropFirstElements(
                app.versions,
                AlacranConstants.configs.maxVersionHistory - 1
            )
    ...
    updateAppDefinitionInDb(
        ...
        return Promise.resolve()
            ...
            .then(function () {
                ...
                if (alacranDefinitionRelativeFilePath) {
                    appObj.alacranDefinitionRelativeFilePath =
    ...
    registerAppDefinition(
        ...
        return new Promise<IAppDef>(function (resolve, reject) {
            ...
            const defaultAppDefinition: IAppDef = {
                ...
                alacranDefinitionRelativeFilePath:
                    AlacranConstants.defaultAlacranDefinitionPath,
                networks: [AlacranConstants.alacranNetworkName],
                envVars: [],
                volumes: [],
                ports: [],
                tags: [],
