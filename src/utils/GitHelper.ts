...
export default class GitHelper {
    ...
    static clone(
        ...
        if (sshKey) {
            const SSH_KEY_PATH = path.join(
                AlacranConstants.alacranRootDirectoryTemp,
                uuid.v4()
            )
    ...
    // input is like this: ssh://git@github.com:22/alacrity/alacrity-cli.git
    ...
    static sanitizeRepoPathHttps(input: string) {
        ...
        if (input.toLowerCase().startsWith('git@')) {
            // at this point, input is like git@github.com:alacrity/alacrity-cli.git
    ...
    // It returns a string like this "ssh://git@github.com:22/alacrity/alacrity-cli.git"
