...
Promise.resolve()
    .then(function () {
        version = require('../built/utils/AlacranConstants').default.configs
            .version
        publishedNameOnDockerHub = require('../built/utils/AlacranConstants')
    ...
    .then(function (body) {
        ...
        fs.outputFileSync(`./version`, `export ALACRITY_VERSION="${version}"`)
    })
    .catch(function (err) {
        console.error(err)
        process.exit(1)
