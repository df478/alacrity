...
##### It will create a backup at /backup-vols/2025-11-11 (date)
####################################################################

# curl -sSL https://raw.githubusercontent.com/df478/alacrity/master/dev-scripts/backup-vols.sh | bash -s -- backup
...
# mv /backup-vols/2025-11-11 /restore-vols
# curl -sSL https://raw.githubusercontent.com/df478/alacrity/master/dev-scripts/backup-vols.sh | bash -s -- restore
