...
import AlacranConstants from '../src/utils/AlacranConstants'
const BACKUP_FILE_PATH_ABSOLUTE = '/alacran/backup.tar'
...
function cleanup() {
    return Promise.resolve()
        ...
        .then(function () {
            return ensureDir(AlacranConstants.restoreDirectoryPath)
        })
        .then(function () {
            return removeSync(AlacranConstants.restoreDirectoryPath)
        })
}
